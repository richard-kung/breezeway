...
#include "breezewayexceptiondialog.h"
...
namespace Breezeway
{
    ...
    void ExceptionListWidget::add()
    {
        ...
        dialog->setWindowTitle( i18n( "New Exception - Breezeway Settings" ) );
    ...
    void ExceptionListWidget::edit()
    {
        ...
        // create dialog
        QPointer<ExceptionDialog> dialog( new ExceptionDialog( this ) );
        dialog->setWindowTitle( i18n( "Edit Exception - Breezeway Settings" ) );
        dialog->setException( exception );
    ...
    void ExceptionListWidget::remove()
    {
        ...
        // confirmation dialog
        {
            QMessageBox messageBox( QMessageBox::Question, i18n("Question - Breezeway Settings" ), i18n("Remove selected exception?"), QMessageBox::Yes | QMessageBox::Cancel );
